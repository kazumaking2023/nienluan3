			        ...
			        <div class="container" id="toathuoc">
			        	...
			        	<div class="row">
			        		...
			        		<div class="col">
								...
								<div class="form-group">
								    <!-- <label class="font-weight-bolder">Số lượng:</label> -->
								    <input type="number" class="form-control form-control-sm" name="sl<?php echo $i;?>" min=0 placeholder="Sáng">
								</div>
								<div class="form-group">
								    <!-- <label class="font-weight-bolder">Số lượng:</label> -->
								    <input type="number" class="form-control form-control-sm" name="sl<?php echo $i;?>" min=0 placeholder="Chiều">
								</div>
								<div class="form-group">
								    <!-- <label class="font-weight-bolder">Số lượng:</label> -->
								    <input type="number" class="form-control form-control-sm" name="sl<?php echo $i;?>" min=0 placeholder="Tối">
								    </div>
