...
<div class="container-fluid" style="margin-left:50px;">
    <table class="table table-hover text-center">
		...
		foreach ($lichsuchua as $key => $val) { 	
			...
			//$mabaohiem = $p->show_info_mabaohiem($val['id_user']);
	...
	?>
          ...
          //if mabahiem not null 
          // if(!empty($user['mabaohiem'])){
          //   $tongtienthuoc1 = $tongtienthuoc - $tongtienthuoc* 0.8;
          // }
           //$tongtienthuoc1 = $tongtienthuoc;

          $mbh = $user['mabaohiem']; 
          if(!empty($mbh)):
            //echo $mbh;
            $khoanbaohiem = $tongtienthuoc* 0.8;
            
          else:
            //echo "Khong co";
            $khoanbaohiem = 0;
          endif;
          $tongtienthuoc1 = $tongtienthuoc - $khoanbaohiem;
          echo $tongtienthuoc1.'.000vnđ'; 
