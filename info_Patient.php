<?php 
  ...
  if(isset($_POST['update'])):
    ...
    $mabaohiem = mysqli_real_escape_string($p->connDB(), $_POST['mabaohiem']);
    $sql = "update user 
            set fullname = '$fullname', gioitinh = '$gioitinh', age = '$age', sdt = '$sdt', address = '$address', mabaohiem = '$mabaohiem'
    ...
    font-family:times;
        ...
        <div class="row" style="padding-top: 70px; margin-left:30px;">
          ...
          <div class="col-3">
            ...
            <p class="font-weight-bolder">Mã bảo hiểm:</p>
          </div>
          <div class="col-4.5 ">
            ...
            <p><?php echo $user['mabaohiem'] == false ? "<span class='font-italic font-weight-light'>Chưa cung cấp</span>": $user['mabaohiem']; ?></p> 
          </div>
          <?php endif;?>
          <div class="col-2"></div> 
        </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="info_Patient.php" method="POST">
                    ...
                    <div class="form-group">
                      <label class="font-weight-bolder">Mã bảo hiểm: </label>
                      <input type="text" class="form-control" name="mabaohiem" minlength="10" maxlength="10" required="required" value="<?php echo $user['mabaohiem']; ?>">
                    </div>  
                </div>
                <div class="modal-footer">
